...
func (client *HTTPClient) GetListTxsByContractAddressHash(contractAddressHash string, queryParams []string, mappingParams map[string]string) (*CommonPaginationResp, error) {
