...
func (handler *AccountTransactions) GetListTokenTransfersByContractAddressHash(ctx *fasthttp.RequestCtx) {
	startTime := time.Now()
...
func (handler *AccountTransactions) GetListTxsByContractAddressHash(ctx *fasthttp.RequestCtx) {
	startTime := time.Now()
