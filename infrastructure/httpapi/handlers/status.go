...
import (
	...
	validatorstats_view "github.com/AstraProtocol/astra-indexing/projection/validatorstats/view"
...
func (handler *StatusHandler) GetStatus(ctx *fasthttp.RequestCtx) {
	...
	// TODO: https://github.com/AstraProtocol/astra-indexing/issues/386
